...
namespace Voxel {
	...
	const VoxelTypeInfo VOXEL_INFO[] = {
		...
		{ 1.0f, 334000.0f, 0.0f, 10,0, 0, 0, 0, 0},	// WATER
		{ 2.3f, 460000.0f, 80000.0f, 1, 8, 1, 0, 0, 0},	// ROCK_1
		{ 3.5f, 700000.0f, 60000.0f, 1, 6, 3, 0, 0, 0},	// ROCK_2
		{ 4.7f, 940000.0f, 50000.0f, 0, 5, 4, 1, 0, 0},	// ROCK_3
		{ 2.6f, 780000.0f, 45000.0f, 0, 4, 7, 0, 0, 0},	// ROCK_4
	};
