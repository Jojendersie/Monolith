...
namespace Marker {
	...
	public:
		...
		/// \param [in] _color The color of a maximal visible line. Fading can
		///		increase the transparency.
		Grid( int _resolutionX, int _resolutionY, int _resolutionZ, float _spacing, const Utils::Color32F& _color, Graphic::Content* _stateObjects );
	...
	private:
		...
		void Create2DSlice( int _resolutionX, int _resolutionZ, float _coordinateY, float _spacing, bool _elliptic, Graphic::Content* _stateObjects );
	};
