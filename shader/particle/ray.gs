...
void main(void)
{
	...
	vec4 l2 = vec4(vs_out_Position[0] + vs_out_Direction[0], 1) * c_mWorldViewProjection;
	...
	vec4 perpendicular = vec4(-dir.y * vs_out_Size[0], dir.x * vs_out_Size[0], 0, 0);
